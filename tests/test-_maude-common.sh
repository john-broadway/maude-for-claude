...
( PATH="$NOFLOCK_PATH" timeout 3 bash -c ". \"$HOOKS_DIR/_maude-common.sh\"; maude_care_set \"$LOCK_CARE\" '.x = 1'" ) >/dev/null 2>&1; NF_RC=$?
...
( PATH="$NOFLOCK_PATH" timeout 10 bash -c ". \"$HOOKS_DIR/_maude-common.sh\"; maude_care_set \"$LOCK_CARE\" '.x = 1'" ) >/dev/null 2>&1; NF_RC=$?
