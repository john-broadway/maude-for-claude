...
# Output: INFO Scheduled collection completed count=128 duration_ms=340 service=my-service
```
...
logger.error(
    ...
    "backup_status", "ConnectionRefused", "host=db.example.com"
)
# Output: ERROR Operation failed op=backup_status error=ConnectionRefused input_summary=host=db.example.com
```
...
# Output: INFO Connecting to database with URL postgresql://user:s3cret@db.example.com/mydb
